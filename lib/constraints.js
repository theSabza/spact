...
_.dobYear = () => {
    ...
    let constraints = {
        ...
        'format' : {
            'pattern' : regex,
            // 'flags' : 'i',
            'message' : 'DOB Year - must match the following pattern: ' + regex
        }
    };
...
_.dobMonth = () => {
    ...
    let constraints = {
        ...
        'format' : {
            'pattern' : regex,
            'flags' : 'i',
            'message' : 'DOB Month - must match the following pattern: ' + regex
        }
    };
...
_.setDobDay = () => {
    ...
    let constraints = {
        ...
        'format' : {
            'pattern' : regex,
            'flags' : 'i',
            'message' : 'DOB Day - must match the following pattern: ' + regex
        }
    };
