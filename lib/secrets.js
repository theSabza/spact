...
// const dummysecrets = require('../ApiDocs/secrets');
...
_.getAllSecretsByTag = async (tag) => {
    ...
    try {
        ...
        //     let newData = await secretsmanager.listSecrets(params).promise();
...
_.load = async () => {
    ...
    try {
        ...
        /**
         * 
         * Remove this block when production build is lauched on the production server
         * Also delete file APIDocs/secrets.json
         * Also uncomment the above functions
         */
        // To be removed when moving to deployment
        // console.log(dummysecrets);
        // secretData = dummysecrets;
        // console.log(userTag)
        _.secrets = secretData;
