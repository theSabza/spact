...
describe('POST /users', () => {
    ...
    test('1. should return a 400 if no payload is sent', async () => {
        validPost.test = 1;
        console.log("Performing test :" + validPost.test)
...
//     // Correct payload
//     test('34. should allow user to be created if handle doesnot exists and is avalible', async () => {
//         validPost.testNo = 18;
//         let payload = cloneDeep(validPost);
//         const {body, status} = await request.post('/users').send(payload);
...
//     test('35. should not allow user to be created if handle already exist', async () => {
//         validPost.testNo = 17;
//         let payload = cloneDeep(validPost);
//         const {body, status} = await request.post('/users').send(payload);
//         expect(status).toEqual(400);
...
//     test('36. should strip white spaces from the name of newly created user', async () => {
//         validPost.testNo = 18;
//         let payload = cloneDeep(validPost);
